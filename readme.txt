...
1. Admin Settings
2. Preview subscribe bar
3. Shortcode settings
4. Widget settings
5. Front-end subscribe bar
6. Sidebar widget
7. Footer widget
...
For Query Monitor's changelog, please see [the Releases page on GitHub](https://github.com/avthemes/YouTube-Channel-Subscribe/releases).
